  ...
  return (
    <section id="inicio" className="relative w-full min-h-screen flex items-center bg-[#FDFBF7] overflow-hidden">
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-12 py-20 lg:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center z-10 w-full">
          ...
          <div className="flex flex-col items-start space-y-2">
            ...
            <div className="relative group">
              <img
                ...
                className="h-32 sm:h-44 lg:h-56 xl:h-[22rem] w-auto object-contain transition-transform duration-500 group-hover:scale-[1.02]"
              />
            </div>
          </div>
        ...
        ================================ */}
        <div className="lg:col-span-7 relative h-[400px] sm:h-[500px] lg:h-[550px] xl:h-[600px] w-full flex items-center justify-center perspective-[1500px] animate-album">
          {Array.from({ length: 5 }).map((_, i) => {
            const index = (current + i) % HOME_IMAGES.length;
            const img = HOME_IMAGES[index];

            // Estilos ajustados para que no ocupen tanto espacio
            const stackStyles = [
