...
export default function StepCategoria({
    ...
    if (categorias.length === 0 && !loading) return null;
    ...
    return (
        <div className="space-y-4">
            ...
            {loading ? (
                <div className="h-14 bg-gray-50 rounded border border-gray-100 animate-pulse"></div>
            ) : (
            ...
            <p className="text-[10px] text-gray-400 font-medium italic">
                * La categoría debe corresponder a la edad de los participantes el día del evento.
            </p>
        </div>
    );
}
